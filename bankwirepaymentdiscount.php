...
class BankWirePaymentDiscount extends Module
{
    ...
    {
        Configuration::updateValue('BANKWIRE_DISCOUNT_PERCENT', '5');
        Configuration::updateValue('BANKWIRE_DISCOUNT_ENABLED', true);
    ...
    {
        Configuration::deleteByName('BANKWIRE_DISCOUNT_PERCENT');
        Configuration::deleteByName('BANKWIRE_DISCOUNT_ENABLED');
            ...
            'form' => [
                ...
                'input' => [
                    [
                        ...
                        'name' => 'BANKWIRE_DISCOUNT_ENABLED',
                        'is_bool' => true,
                    ...
                    [
                        ...
                        'name' => 'BANKWIRE_DISCOUNT_PERCENT',
    ...
    {
        return [
            'BANKWIRE_DISCOUNT_PERCENT' => (float) Configuration::get('BANKWIRE_DISCOUNT_PERCENT', 5),
            'BANKWIRE_DISCOUNT_ENABLED' => (bool) Configuration::get('BANKWIRE_DISCOUNT_ENABLED', true),
        ];
    }
    ...
    protected function postProcess()
    {
        ...
        $discountPercent = str_replace(',', '.', Tools::getValue('BANKWIRE_DISCOUNT_PERCENT'));
        $discountEnabled = (bool) (int) Tools::getValue('BANKWIRE_DISCOUNT_ENABLED');
        ...
        Configuration::updateValue('BANKWIRE_DISCOUNT_PERCENT', (float) $discountPercent);
        Configuration::updateValue('BANKWIRE_DISCOUNT_ENABLED', $discountEnabled);
    ...
    {
        if (!$this->active || !Configuration::get('BANKWIRE_DISCOUNT_ENABLED')) {
            return [];
        }
    ...
    public function hookDisplayPaymentByBinaries($params)
    {
        ...
        if ($cart->id) {
            ...
            return $this->display(__FILE__, 'views/templates/hook/payment_discount.tpl');
        }
    }
    ...
    public function hookDisplayShoppingCartFooter($params)
    {
        ...
        if ($cart->id) {
            ...
            return $this->display(__FILE__, 'views/templates/hook/cart_discount_info.tpl');
        }
    }
    ...
    public function hookDisplayPaymentTop($params)
    {
        ...
        if ($cart->id) {
            ...
            return $this->display(__FILE__, 'views/templates/hook/payment_top_discount.tpl');
        }
    }
    ...
    public function applyBankWireDiscount($cart)
    {
        ...
        foreach ($cartRules as $rule) {
            if (!empty($rule['code']) && strpos($rule['code'], 'BANKWIRE_DISCOUNT_') === 0) {
        ...
        $cartRule->code = 'BANKWIRE_DISCOUNT_' . (int) $cart->id;
